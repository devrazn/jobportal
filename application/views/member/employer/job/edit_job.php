	        ...
	        <div class="form-container">
	            ...
	            <form role="form"  method="post" action="<?=base_url().'employer_profile/edit_job/'.$job['id']?>">
	                <div class="form-group col-md-12">
	                    ...
	                    <div class="col-md-4">
	                        <input type="text" name="title" class="form-control"  placeholder=" Enter Title" value="<?= set_value('title', $job['title']) ?>"/>
	                     <?= form_error('title') ?>
	                    </div>
	                </div>
	                <div class="form-group col-md-12">
	                    ...
	                    <div class="col-md-4">
	                       <input type="text" name="position" class="form-control" placeholder="Enter Position" value="<?= set_value('position', $job['position']) ?>"/>
	                     <?= form_error('position') ?>
	                    </div>
	                </div>
	                ...
	                <div class="form-group">
	                	<div class="form-group col-md-12">
	                		...
	                		<div class="col-md-4">
	                           <input type="text" name="qualification" class="form-control" placeholder="Enter Qualification" value="<?= set_value('qualification', $job['qualification'] ?>"/>
	                ...
	                <div class="form-group">
	                	<div class="form-group col-md-12">
	                		...
	                		<div class="col-md-4">
	                			<input type="text" name="experience" class="form-control" placeholder="Enter Experience" value="<?=set_value('experience', $job['experience']) ?>"/>
	                ...
	                <div class="form-group">
	                	<div class="form-group col-md-12">
	                		...
	                		<div class="col-md-4">
	                			<input type="text" name="salary" class="form-control" placeholder="Enter Salary" value="<?= set_value('salary', $job['salary']) ?>"/>
