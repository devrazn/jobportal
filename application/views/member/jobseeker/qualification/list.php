...
<div class="col-md-8 single_right">
    ...
    <div class="panel-heading">
      <a class="btn btn-primary" href="<?=base_url().'user_profile/add_qualification';?>">Add New</a>   
    </div>
    <div class="well">
        <div class="dataTable_wrapper">
        <table id="employer_qualification_dataTables" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <!-- <table class="table table-striped table-hover" id="employer_qualification_dataTables"> -->
              ...
              <tbody>
                ...
                <tr> 
                  ...
                  <td><a href="<?=base_url().'user_profile/edit_qualification/'.$qualification['id']?>"><?=$qualification['remarks']?></a></td>
