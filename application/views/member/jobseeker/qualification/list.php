...
<div class="col-md-8 single_right">
    ...
    <div class="well">
        <div class="dataTable_wrapper">
            <table class="table table-striped table-hover" id="employer_qualification_dataTables">
              <thead>
                <tr>
                  <th>Degree</th>
                  <th>Institution</th>
              ...
              <tbody>
                ...
                ?>
                 <tr id="tr_<?php echo $qualification['id']; ?>">
                  ...
                  <td><a href="<?=base_url().'user_profile/edit_qualification/'.$qualification['id']?>"><?=$qualification['gpa_pct']?></a></td>0
                  <td><a class="btn btn-danger delete" data-id="<?php echo $qualification['id'];?>" data-toggle="tooltip" title="Delete"  data-original-title="Delete"><i class="fa fa-trash-o fa-lg"></i> Delete</a></td>
                </tr>
                      <?php
...
<script>
  $(document).ready(function() {
    ...
    $('body').on('click', '.delete', function(e) {
      setDelete('user_profile/delete_qualification/','5',this,'Qualification');
    });
