                ...
                <form role="form"  method="post" action="<?=base_url().'user_profile/edit_qualification/'.$row['id']?>" enctype="multipart/form-data">
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="degree" class="form-control"  placeholder="Enter Degree" value="<?=set_value('degree',$row['degree']);?>">
                                <?= form_error('degree') ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="institution" class="form-control" placeholder="Enter Institution" value="<?=set_value('institution',$row['institution']);?>"/>
                    ...
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4">
                                <select name="completion_date" class="form-control">
                    ...
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4">
                                <input type="text" name="gpa_pct" class="form-control" placeholder="Enter GPA/Percentage" value="<?=set_value('gpa_pct',$row['gpa_pct']);?>"/>
                                <?= form_error('gpa_pct') ?>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4">
                                <textarea cols="39" rows="6" name="remarks"><?=set_value('remarks',$row['remarks']);?></textarea>
                                <?= form_error('remarks') ?>
                            </div>
                        </div>
                    </div>
