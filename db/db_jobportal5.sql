...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2015 at 03:42 PM
...
(1, 'admin', 'da59084321a29d1ae755567ef17babd1994a9d7cd6375c13da2c90708944e7bc169fbcf1063a8370850cc53ded6b87ac436bab9e6cd6c01e1095ab02bd8c7f43u3fzM5kgWch/AWa+YAQoyljWMb1itw==', '', 'admin', 'admin@admin.com', NULL, NULL, '6cec853d35ad8dfffc5ef4c85588f296', '', 0);
...
CREATE TABLE IF NOT EXISTS `tbl_email_templates` (
  ...
  `TemplateCode` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `TemplateSubject` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `TemplateDesign` text COLLATE utf8_unicode_ci,
  `del_flag` tinyint(4) NOT NULL DEFAULT '0',
  `status` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbl_email_templates` (`TemplateID`, `TemplateCode`, `TemplateSubject`, `TemplateDesign`, `del_flag`, `status`) VALUES
(11, 'EMAIL_FRIEND', 'This is interesting   [SITENAME], Check it out!', '<p>\n	Dear @@FRIEND@,</p>\n<p>\n	<span style="font-weight: bold;">@@FNAME@</span>&nbsp;would like you to check out our exciting website! &nbsp; Use the link below to get over there and be sure to ask&nbsp;<span style="font-weight: bold;">@@FNAME@&nbsp;</span>about how much they like us!</p>\n<p>\n	@@REFERLINK@</p>\n<p>\n	<strong>@@SITENAME@ Support Team</strong></p>\n', 0, '');
