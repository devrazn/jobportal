...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2015 at 08:01 PM
...
CREATE TABLE IF NOT EXISTS `tbl_admin` (
  ...
  `del_flag` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(1, 'admin', 'd20e9ed4a9189bc17bb4ea542d0a114314ece8204fe77a17d2279b99b82980ecde36fcdca54dc3610bb3697c80b5a9741f6b47122d211db7c82b2f1342e4b00ddUHLFs28sMWwETg92r6Rbm0PbkEA', '', 'admin', 'admin@admin.com', NULL, NULL, '', '');
...
INSERT INTO `tbl_newsletter` (`id`, `title`, `content`) VALUES
(8, 'Test Letter', '<p>\r\n	Test Letter</p>\r\n'),
(7, 'Test', '<p>\r\n	Test</p>\r\n'),
(6, 'Test', '<p>\r\n	Test</p>\r\n');
