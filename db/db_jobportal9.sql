...
-- ----------------------------
INSERT INTO `tbl_admin` VALUES ('1', 'admin', 'ec0151f42f1e7bc746b319d5a2af535a88ed8097651da521d919faae2e01fa4aeb8213c4a0da8894ac363ea75a7c1a70cab7368f71b47bf9dd4a7b99dc5f2be8sc6KhqrrtdIVpoM9TXVwtIynTl2nhA==', '', 'admin', 'admin@admin.com', null, null, '1fb05b5e3b944330466c252874cc9f12', '', '0');
...
-- ----------------------------
INSERT INTO `tbl_contact_us` VALUES ('1', '+977-4-000000', '+977-4-000000', 'enquiry@jobportal.com', '9:30', '5:30', '10:00', '1:30', '27.703767489333238', '85.32324917586357', '', 'Putalisadak, Kathmandu 44600, Nepal');
...
CREATE TABLE `tbl_experience` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKEY1` (`user_id`),
  CONSTRAINT `FKEY1` FOREIGN KEY (`user_id`) REFERENCES `tbl_users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of tbl_experience
-- ----------------------------
INSERT INTO `tbl_experience` VALUES ('1', '1', 'Junior', 'abc', '1 year', 'programmer', '0', '1');
INSERT INTO `tbl_experience` VALUES ('2', '2', 'Senior', 'def', '2 year', 'QA', '0', '0');
...
-- ----------------------------
INSERT INTO `tbl_job_category` VALUES ('1', 'php1', '1', '0');
INSERT INTO `tbl_job_category` VALUES ('2', 'csv', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('3', 'sdfdfsg', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('4', 'dsaf', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('5', 'sdf', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('6', 'sdfgsfdg', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('7', 'sdfhgfd', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('8', 'dsafasd', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('9', 'dsfds', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('10', 'cat1', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('11', 'PHP Programmer', '1', '1');
INSERT INTO `tbl_job_category` VALUES ('12', 'Front End JavaScript Programmer', '0', '0');
INSERT INTO `tbl_job_category` VALUES ('13', 'Java Programmer', '0', '1');
...
-- ----------------------------
INSERT INTO `tbl_newsletter` VALUES ('8', 'Test Letter', '<p>\r\n	Test Letter</p>\r\n', '0', '');
INSERT INTO `tbl_newsletter` VALUES ('7', 'Test', '<p>\r\n	Test</p>\r\n', '0', '');
INSERT INTO `tbl_newsletter` VALUES ('6', 'Test', '<p>\r\n	Test</p>\r\n', '0', '');
...
-- ----------------------------
-- Records of tbl_qualification
-- ----------------------------
INSERT INTO `tbl_qualification` VALUES ('1', 'Bachalor', 'KCC', '2015-10-14', '3.2', '1', '0', '1');
INSERT INTO `tbl_qualification` VALUES ('2', 'Bachalor', 'KIC', '2015-10-05', '2.9', '2', '0', '1');

-- ----------------------------
-- Table structure for `tbl_site_settings`
-- ----------------------------
...
-- ----------------------------
-- Records of tbl_site_settings
-- ----------------------------
INSERT INTO `tbl_site_settings` VALUES ('1', 'Job Portal', 'Job Portal - Hire or Get Hired', 'fd1225410e87f31aaad72a59d7e4446e.JPG', 'The Coolest & the Hottest Jobs for You', 'Job Portal, the leading job listing site.', 'Job Portal is an online job listing site where employees and employers find the best for each other.', 'Job Portal - Team', '<p>\r\n The Site is Currently Offline and Under Maintenance.</p>\r\n<p>\r\n Please visit back later.</p>\r\n<p>\r\n Thank You.</p>\r\n<p>\r\n - Job Portal</p>\r\n', 'rajanacharyapkr@gmail.con', '1', 'tuesdaystore', '', 'http://facebook.com/jobportal', 'http://twitter.com/jobportal', 'http://www.youtube.com/jobportal', 'http://www.youtube.com', 'http://www.youtube.com', 'http://www.youtube.com', '3', '£', '0', '0', '1111111111111', '12', '27.701806,85.311906', '15', 'demo@uno.com', '654321');
...
-- Records of tbl_tags
-- ----------------------------
INSERT INTO `tbl_tags` VALUES ('1', 'php', '11', '0', '0');
INSERT INTO `tbl_tags` VALUES ('2', 'csv1', '2', '0', '1');
INSERT INTO `tbl_tags` VALUES ('3', '.net', '10', '0', '1');

-- ----------------------------
-- Table structure for `tbl_tag_map_experience`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_tag_map_experience`;
CREATE TABLE `tbl_tag_map_experience` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of tbl_tag_map_experience
-- ----------------------------

-- ----------------------------
-- Table structure for `tbl_tag_map_job`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_tag_map_job`;
CREATE TABLE `tbl_tag_map_job` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `tbl_users` (
  ...
  `user_type` tinyint(11) NOT NULL DEFAULT '0' COMMENT '0:Employer, 1:JobSeeker',
...
-- ----------------------------
INSERT INTO `tbl_users` VALUES ('1', 'neetu123@gmail.com', '12345', 'Neetu', 'Pradhan', 'F', '2015-10-20', 'Sanepa', 'qaz', 'qaz', 'qaz', 'aa', 'single', '565454365465', '0', 'aa', '0', '1');
INSERT INTO `tbl_users` VALUES ('2', 'ram12@gmail.com', 'malla', 'Ram', 'Malla', 'M', '2015-10-21', 'Kathmandu', 'asd', 'asd', 'asd', 'asd', 'S', '9867554567', '1', 'aa', '0', '1');

-- ----------------------------
-- Table structure for `tbl_user_jobs`
-- ----------------------------
DROP TABLE IF EXISTS `tbl_user_jobs`;
CREATE TABLE `tbl_user_jobs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `job_id` int(11) NOT NULL,
